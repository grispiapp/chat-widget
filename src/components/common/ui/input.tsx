...
export const Input: FC<InputProps> = ({ label, error, type, name, className, ...props }) => {
    ...
    return (
        <div className="cb-space-y-1">
            ...
            <input
                ...
                name={name}
                className={cn(className, "cb-block cb-w-full cb-rounded cb-border cb-p-2 focus:cb-outline-primary", {
