...
export const ContentCommonError = () => {
    ...
    return (
        <div className="cb-flex cb-h-48 cb-flex-col cb-items-center cb-justify-center cb-space-y-2 cb-p-4 cb-text-center">
            ...
            <h3 className="cb-text-xl cb-font-bold">{t("errors.common.title")}</h3>
            <p className="cb-text-muted-foreground">{t("errors.common.text")}</p>
        </div>
    );
};
