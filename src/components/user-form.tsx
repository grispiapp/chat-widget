import ChatBoxContext, { type ChatBoxContextType } from "@context/chat-box-context";
...
export const UserForm = () => {
    ...
    return (
        <div className="cb-space-y-3 cb-rounded-lg cb-border-2 cb-border-primary cb-bg-background cb-p-3 cb-text-sm cb-text-foreground cb-backdrop-blur-lg">
            <div>
                <h3 className="cb-font-medium cb-text-primary">Contact Informations</h3>
                <p className="cb-text-muted-foreground cb-text-xs">
                    Please provide your contact information below to establish a connection with an agent.
                </p>
            </div>
